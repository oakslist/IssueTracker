...
/**
 * Servlet implementation class BeforeShowProjectsController
 */

public class BeforeShowProjectsController extends AbstractBaseController {
	...
	protected void performTask(HttpServletRequest request,
		...
		try {
			...
			jumpPage(ServletConstants.JUMP_SHOW_PROJECT_PAGE, request, response);
