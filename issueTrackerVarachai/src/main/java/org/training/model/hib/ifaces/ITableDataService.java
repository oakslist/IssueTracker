...
public interface ITableDataService {
	...
	public Status getStatusByName(String name) throws DaoException;
	...
	public Project getProjectByNameAndBuild(String name, String buildValue) throws DaoException;
