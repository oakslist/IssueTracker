	...
	<header class="main-header">
		...
		<c:when test="${empty user.emailAddress}">
			<form method="POST" action="<c:url value='/login'/>">
				...
				just USE email: <b>ad@ad.ad</b> pass: <b>ad</b> OR email: <b>us@us.us</b> pass: <b>us</b><br>
		...
		<c:otherwise>
			<div class="login-place-header">
				<div class="user-menu-header">
					<a href="<c:url value='/user/${user.userId}/menu'/>">User Menu</a>
				</div>
				<div class="first-name-header">
					<span>Hello, <a href="<c:url value='/user/${user.userId}/menu'/>">${user.firstName}</a>!</span>
				</div>
		...
		<div class="pages-header">
			<ul>
				<li class="home-page"><a href="<c:url value='/index'/>">HOME</a></li>
				<li class="defects-page"><a href="<c:url value='/issue/all'/>">ISSUES</a></li>
			</ul>
