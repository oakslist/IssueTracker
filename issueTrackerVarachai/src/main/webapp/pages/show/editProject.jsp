...
<script type="text/javascript"
	src="<c:url value='/pages/js/script.js'/>"></script>
		...
		<div class="main">
			...
			<c:choose>
				<c:when test="${user.role.roleName eq 'ADMINISTRATOR'}">
					<form method="POST"
						action="<c:url value='/EditProjectController'/>">
						<table>
							<tr>
							...
							<tr>
								...
								<td><a href="<c:url value='pages/show/addProjectBuild.jsp'/>">Add Build</a></td>
							</tr>
							<tr>
								...
								<td><a href="<c:url value='pages/addUser.jsp'/>">Add User</a></td>
							</tr>
						</table>
